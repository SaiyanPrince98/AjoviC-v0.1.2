...
pickle.dump(X_train.astype(np.float16), open('Data/[RAVDESS][MEL_SPECT][X_train].p', 'wb'))
pickle.dump(y_train, open('Data/[RAVDESS][MEL_SPECT][y_train].p', 'wb'))
pickle.dump(X_test.astype(np.float16), open('Data/[RAVDESS][MEL_SPECT][X_test].p', 'wb'))
pickle.dump(y_test, open('Data/[RAVDESS][MEL_SPECT][y_test].p', 'wb'))